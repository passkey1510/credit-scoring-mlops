"""Feature names for the credit scoring model (795 features)."""
...
FEATURE_NAMES: list[str] = [
    ...
    "BURO_CREDIT_TYPE_Cash_loan_non_earmarked__MEAN",
    ...
    "BURO_CREDIT_TYPE_Loan_for_purchase_of_shares_margin_lending__MEAN",
    ...
    "PREV_NAME_CASH_LOAN_PURPOSE_Buying_a_holiday_home_land_MEAN",
    ...
    "PREV_NAME_CASH_LOAN_PURPOSE_Wedding_gift_holiday_MEAN",
    ...
    "PREV_NAME_PAYMENT_TYPE_Non_cash_from_your_account_MEAN",
    ...
    "PREV_NAME_GOODS_CATEGORY_Additional_Service_MEAN",
    ...
    "PREV_NAME_GOODS_CATEGORY_House_Construction_MEAN",
